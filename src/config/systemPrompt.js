...
Step 1: Fetch all key observations simultaneously using separate search_patient_observations calls with PATIENT and respective LOINC codes looked up from the LOINC_CODES knowledge base
...
## CHARTS
If the user asks for a chart or graph of data (e.g. "show as a chart", "plot the glucose values", "graph the creatinine trend", "plot trends"):
...
- Refer to Section 4 (Deterioration Patterns / Abnormal Observations) under search_patient_observations — apply the same approach to fetch all clinically relevant observations.
